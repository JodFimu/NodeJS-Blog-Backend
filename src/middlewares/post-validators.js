...
export const postValidator = [
    ...
    body('course').notEmpty().withMessage('Course is required').isIn(['Tecnología', 'Practica Supervisada', 'Taller']).withMessage('Course must be one of the following: Tecnología, Practicas, Taller'),
    validateField,
    deleteFileOnError,
    handleErrors
];
